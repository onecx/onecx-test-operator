...
app:
  ...
  envCustom:
    ...
    - name: ONECX_TEST_SCHEDULER_TIMER
      value: "24h"
    - name: ONECX_TEST_SCHEDULER_PRIVATE_RUN_URL
      value: ""
    - name: ONECX_TEST_SCHEDULER_PRIVATE_RUN_SERVICES
      value: ""
    - name: ONECX_TEST_SCHEDULER_PUBLIC_RUN_URL
      value: ""
    - name: ONECX_TEST_SCHEDULER_PUBLIC_RUN_SERVICES
      value: ""
  operator:
    keycloak:
      client:
